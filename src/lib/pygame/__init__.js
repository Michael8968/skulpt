...
PygameLib.extract_color = function (color) {
    ...
    if (Sk.abstr.typeName(color) === "Color") {
        color_js[0] = Sk.ffi.remapToJs(color['r']);
        color_js[1] = Sk.ffi.remapToJs(color['g']);
        color_js[2] = Sk.ffi.remapToJs(color['b']);
...
PygameLib.extract_rect = function (rect) {
    ...
    if (Sk.abstr.typeName(rect) === "Rect") {
        rect_js[0] = Sk.ffi.remapToJs(rect['left']);
        rect_js[1] = Sk.ffi.remapToJs(rect['top']);
        rect_js[2] = Sk.ffi.remapToJs(rect['width']);
        rect_js[3] = Sk.ffi.remapToJs(rect['height']);
    } else {
...
var createKeyboardEvent = function (event) {
    ...
    var code = keyKeyCodeLocationCodeMap[[event.key.toLowerCase(), event.keyCode, event.location].toString()];
    if (code) {
      event.code = code;
      var key = keyMap[code];
      if (key) {
        return [keyPGConstant, { key: key }];
      }
    }
    switch (event.which) {
...
PygameLib.constants = {
    ...
    '__name__': 'pygame.PygameLib.constants',
    '__package__': 'pygame',
    'ACTIVEEVENT': 1,
    'ANYFORMAT': 268435456,
    'ASYNCBLIT': 4,
...
var keyMap = {
  'AltLeft': PygameLib.constants.K_LALT,
  'AltRight': PygameLib.constants.K_RALT,
  'ControlLeft': PygameLib.constants.K_LCTRL,
  'ControlRight': PygameLib.constants.K_LCTRL,
  'MetaLeft': PygameLib.constants.K_LMETA,
  'MetaRight': PygameLib.constants.K_RMETA,
  'ShiftLeft': PygameLib.constants.K_LSHIFT,
  'ShiftRight': PygameLib.constants.K_RSHIFT,
  'CapsLock': PygameLib.constants.K_CAPSLOCK,
  'Escape': PygameLib.constants.K_ESCAPE,
  'F1': PygameLib.constants.K_F1,
  'F2': PygameLib.constants.K_F2,
  'F3': PygameLib.constants.K_F3,
  'F4': PygameLib.constants.K_F4,
  'F5': PygameLib.constants.K_F5,
  'F6': PygameLib.constants.K_F6,
  'F7': PygameLib.constants.K_F7,
  'F8': PygameLib.constants.K_F8,
  'F9': PygameLib.constants.K_F9,
  'F10': PygameLib.constants.K_F10,
  'F11': PygameLib.constants.K_F11,
  'F12': PygameLib.constants.K_F12,
  'ArrowUp': PygameLib.constants.K_UP,
  'ArrowLeft': PygameLib.constants.K_LEFT,
  'ArrowRight': PygameLib.constants.K_RIGHT,
  'ArrowDown': PygameLib.constants.K_DOWN,
  'Semicolon': PygameLib.constants.K_SEMICOLON,
  'Quote': PygameLib.constants.K_QUOTE,
  'BracketRight': PygameLib.constants.K_RIGHTBRACKET,
  'BracketLeft': PygameLib.constants.K_LEFTBRACKET,
  'Digit0': PygameLib.constants.K_0,
  'Digit1': PygameLib.constants.K_1,
  'Digit2': PygameLib.constants.K_2,
  'Digit3': PygameLib.constants.K_3,
  'Digit4': PygameLib.constants.K_4,
  'Digit5': PygameLib.constants.K_5,
  'Digit6': PygameLib.constants.K_6,
  'Digit7': PygameLib.constants.K_7,
  'Digit8': PygameLib.constants.K_8,
  'Digit9': PygameLib.constants.K_9,
  'Backspace': PygameLib.constants.K_BACKSPACE,
  'Enter': PygameLib.constants.K_RETURN,
  'Tab': PygameLib.constants.K_TAB,
  'Space': PygameLib.constants.K_SPACE,
  'Comma': PygameLib.constants.K_COMMA,
  'Period': PygameLib.constants.K_PERIOD,
  'Slash': PygameLib.constants.K_SLASH,
  'Backslash': PygameLib.constants.K_BACKSLASH,
  'IntlBackslash': PygameLib.constants.K_BACKQUOTE,
  'Minus': PygameLib.constants.K_MINUS,
  'Equals': PygameLib.constants.K_EQUALS,
  'KeyQ': PygameLib.constants.K_q,
  'KeyW': PygameLib.constants.K_w,
  'KeyE': PygameLib.constants.K_e,
  'KeyR': PygameLib.constants.K_r,
  'KeyT': PygameLib.constants.K_t,
  'KeyY': PygameLib.constants.K_y,
  'KeyU': PygameLib.constants.K_u,
  'KeyI': PygameLib.constants.K_i,
  'KeyO': PygameLib.constants.K_o,
  'KeyP': PygameLib.constants.K_p,
  'KeyA': PygameLib.constants.K_a,
  'KeyS': PygameLib.constants.K_s,
  'KeyD': PygameLib.constants.K_d,
  'KeyF': PygameLib.constants.K_f,
  'KeyG': PygameLib.constants.K_g,
  'KeyH': PygameLib.constants.K_h,
  'KeyJ': PygameLib.constants.K_j,
  'KeyK': PygameLib.constants.K_k,
  'KeyL': PygameLib.constants.K_l,
  'KeyZ': PygameLib.constants.K_z,
  'KeyX': PygameLib.constants.K_x,
  'KeyC': PygameLib.constants.K_c,
  'KeyV': PygameLib.constants.K_v,
  'KeyB': PygameLib.constants.K_b,
  'KeyN': PygameLib.constants.K_n,
  'KeyM': PygameLib.constants.K_m,
...
var surface$1 = function $Surface$class_outer(gbl, loc) {
    ...
    loc.get_alpha = new Sk.builtin.func(function (self) {
        var alpha = (1-Sk.ffi.remapToJs(self._blitAlpha))*255;
...
function color_type_f($gbl, $loc) {
    ...
    $loc.__repr__ = new Sk.builtin.func(function (self) {
        var r = Sk.ffi.remapToJs(self['r']);
        var g = Sk.ffi.remapToJs(self['g']);
        var b = Sk.ffi.remapToJs(self['b']);
        var a = Sk.ffi.remapToJs(self['a']);
    ...
    var cmy_setter = new Sk.builtin.func(function (self, val) {
        ...
        self['r'] = Sk.ffi.remapToPy(255 - cmy[0] * 255);
        self['g'] = Sk.ffi.remapToPy(255 - cmy[1] * 255);
        self['b'] = Sk.ffi.remapToPy(255 - cmy[2] * 255);
    });
    ...
    var hsva_getter = new Sk.builtin.func(function (self) {
        ...
        var rr, gg, bb,
            r = Sk.ffi.remapToJs(self['r']) / 255,
            g = Sk.ffi.remapToJs(self['g']) / 255,
            b = Sk.ffi.remapToJs(self['b']) / 255,
            h, s,
            v = Math.max(r, g, b),
    ...
    var hsva_setter = new Sk.builtin.func(function (self, val) {
        ...
        self['r'] = Sk.ffi.remapToPy(Math.round(r * 255));
        self['g'] = Sk.ffi.remapToPy(Math.round(g * 255));
        self['b'] = Sk.ffi.remapToPy(Math.round(b * 255));
        self['a'] = Sk.ffi.remapToPy(Math.round(hsva[3] / 100 * 255));
    });
    ...
    var hsla_setter = new Sk.builtin.func(function (self, val) {
        ...
        self['g'] = Sk.ffi.remapToPy(Math.round(g * 255));
        self['b'] = Sk.ffi.remapToPy(Math.round(b * 255));
        self['a'] = Sk.ffi.remapToPy(Math.round(a * 255));
    });
    ...
    $loc.correct_gamma = new Sk.builtin.func(function (self, val) {
        ...
        self['r'] = Sk.ffi.remapToPy(r);
        self['g'] = Sk.ffi.remapToPy(g);
        self['b'] = Sk.ffi.remapToPy(b);
        self['a'] = Sk.ffi.remapToPy(a);
    ...
    var r_getter = new Sk.builtin.func(function (self) {
        return self['r'];
    });
    var r_setter = new Sk.builtin.func(function (self, val) {
        self['r'] = val;
    });
    $loc.r = Sk.misceval.callsimOrSuspend(Sk.builtins.property, r_getter, r_setter);

    var g_getter = new Sk.builtin.func(function (self) {
        return self['g'];
    });
    var g_setter = new Sk.builtin.func(function (self, val) {
        self['g'] = val;
    });
    $loc.g = Sk.misceval.callsimOrSuspend(Sk.builtins.property, g_getter, g_setter);

    var b_getter = new Sk.builtin.func(function (self) {
        return self['b'];
    });
    var b_setter = new Sk.builtin.func(function (self, val) {
        self['b'] = val;
    });
    $loc.b = Sk.misceval.callsimOrSuspend(Sk.builtins.property, b_getter, b_setter);

    var a_getter = new Sk.builtin.func(function (self) {
        return self['a'];
    });
    var a_setter = new Sk.builtin.func(function (self, val) {
        self['a'] = val;
    });
    $loc.a = Sk.misceval.callsimOrSuspend(Sk.builtins.property, a_getter, a_setter);
...
function rect_type_f($gbl, $loc) {
    $loc.__init__ = new Sk.builtin.func(function (self, a, b, c, d) {
        ...
        if (Sk.abstr.typeName(a) === "tuple" && Sk.abstr.typeName(b) === "tuple") {
            ...
            self['left'] = Sk.ffi.remapToPy(a_js[0]);
            self['top'] = Sk.ffi.remapToPy(a_js[1]);
            self['width'] = Sk.ffi.remapToPy(b_js[0]);
            self['height'] = Sk.ffi.remapToPy(b_js[1]);
    ...
    $loc.__repr__ = new Sk.builtin.func(function (self) {
        var left = Sk.ffi.remapToJs(self['left']);
        var top = Sk.ffi.remapToJs(self['top']);
        var width = Sk.ffi.remapToJs(self['width']);
        var height = Sk.ffi.remapToJs(self['height']);
    ...
    function get_top(self) {
        return Sk.ffi.remapToJs(self['top']);
    }

    function get_height(self) {
        return Sk.ffi.remapToJs(self['height']);
    }
    ...
    function get_left(self) {
        return Sk.ffi.remapToJs(self['left']);
    }

    function get_width(self) {
        return Sk.ffi.remapToJs(self['width']);
    }
    ...
    function set_top(self, t) {
        self['top'] = Sk.ffi.remapToPy(t);
    }

    function set_height(self, h) {
        self['height'] = Sk.ffi.remapToPy(h);
    }
    ...
    function set_left(self, l) {
        self['left'] = Sk.ffi.remapToPy(l);
    }

    function set_width(self, w) {
        self['width'] = Sk.ffi.remapToPy(w);
    }
    ...
    $loc.width = Sk.misceval.callsimOrSuspend(Sk.builtins.property, w_getter, w_setter);
    ...
    $loc.height = Sk.misceval.callsimOrSuspend(Sk.builtins.property, h_getter, h_setter);
    ...
    var left_getter = new Sk.builtin.func(function (self) {
        return Sk.ffi.remapToPy(get_left(self));
    });
    var left_setter = new Sk.builtin.func(function (self, val) {
