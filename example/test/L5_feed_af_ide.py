...
class People(object):
    def __init__(self):
        ...
        #self.image = self.load('lesson5/zoulu.png', 105, 221, 4)
    ...
    def load(self, filename, width, height, columns):
        ...
        for i in range(columns):
            ...
            for j in range(columns):
                ...
                image.append(self.master_image.subsurface(rect))
        return image
    '''
    ...
    def show(self):
        ...
        if self.backNum == 0:
            ...
            for n in range(30):
                ...
                self.showMeat()
                self.showNum()
               # pika = pygame.image.load('lesson5/pika.png').convert_alpha()
                #bac1 = pygame.transform.smoothscale(bac1, (800,600))
                #guai1 = pygame.image.load('lesson5/guai3.png').convert_alpha()
                #guai2 = pygame.image.load('lesson5/guai4.png').convert_alpha()
                screen.blit(self.pika, (200,400))
                screen.blit(self.guai1, (500,10))
                pygame.display.update()
            '''
            if self.eat < 4:
                for n in range(30):
                    ...
                    self.showMeat()
                    self.showNum()
                    aa = pygame.transform.smoothscale(self.meat, (50,50))
